  ...
  if (loading)
    return (
      <div className="w-full flex flex-col justify-start   items-start container gap-4  m-auto">
        <div className=" py-4 gap-4  items-start justify-start grid md:grid-cols-10 grid-cols-3  min-h-auto ">
  ...
  return (
    <div className="flex justify-start container gap-6 py-6">
      {stories?.map((story, index) => (
        <div
          key={story.id}
          className="w-20 h-20 rounded-full border-4 border-red-500 p-1 cursor-pointer"
